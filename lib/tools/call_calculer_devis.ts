import { tool } from 'ai'
import { z } from 'zod'
import type { DevisResult } from '@/types'

// ─────────────────────────────────────────────
// STUB — waiting for P5's calculer_devis()
// ─────────────────────────────────────────────
// On J4, replace the mock below with the real import:
//   import { calculer_devis } from '@/lib/pricing/calculer_devis'
// ─────────────────────────────────────────────

function calculer_devis_stub(params: {
  nb_passagers: number
  date_depart: string
  date_demande: string
  distance_km: number
  ...
  // Placeholder calculation — NOT for production use.
  // Replace entirely with P5's function on J4.
